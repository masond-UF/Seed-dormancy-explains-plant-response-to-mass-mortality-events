# This is a script containing frequently used functions for the NRI-MME project


# Code for calculating confidence intervals ####
...
# Biostats code for trimming common and rare species from multivariate data ####
