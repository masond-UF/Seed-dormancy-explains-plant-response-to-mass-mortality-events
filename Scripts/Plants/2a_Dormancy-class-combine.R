## --------------- HEADER ------------------------------------------------------
## Script name: 2a_Dormancy-class-combine.R
...
# Bring in the unaggregated wide raw data from 2019-2020
march2019 <- read.csv("Animals-plants-seeds/Raw-data/Plants/transect-veg-survey/2019-March-raw-wd.csv")
april2019 <- read.csv("Animals-plants-seeds/Raw-data/Plants/transect-veg-survey/2019-April-raw-wd.csv")
may2019 <- read.csv("Animals-plants-seeds/Raw-data/Plants/transect-veg-survey/2019-May-raw-wd.csv")
june2019 <- read.csv("Animals-plants-seeds/Raw-data/Plants/transect-veg-survey/2019-June-raw-wd.csv")
july2019 <- read.csv("Animals-plants-seeds/Raw-data/Plants/transect-veg-survey/2019-July-raw-wd.csv")
july2020 <- read.csv("Animals-plants-seeds/Raw-data/Plants/transect-veg-survey/2020-July-raw-wd.csv")

# Bring in the unaggregated long raw data from 2021
july2021 <- read.csv("Animals-plants-seeds/Raw-data/Plants/transect-veg-survey/2021_July-raw-lg.csv")
...
write.csv(comb.transect.lg,
  "Animals-plants-seeds/Raw-data/Plants/Combined-transect-lg.csv",
  row.names = FALSE
)
