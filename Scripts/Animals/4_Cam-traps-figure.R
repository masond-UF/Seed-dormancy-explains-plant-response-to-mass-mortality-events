...
decomp.means <- read.csv("Animals-plants-seeds/Analysis/Animals/Decomp-means.csv")
herb.means <- read.csv("Animals-plants-seeds/Analysis/Animals/Herb-means.csv")
...
ggsave(
	plot = p,
	filename = "Animals-plants-seeds/Figures/Animals/Functional-detections.png",
	bg = "transparent",
	width = 8,
	height = 13,
	units = 'in'
